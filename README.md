...
✨️ 我们已经将这项工作进一步扩展为一篇论文，并成功被 IJCAI2024 录用。论文的详细信息可以在网站 https://dids-ei.github.io/Project/LLM-OBTEA/ 查看，代码可通过 https://github.com/DIDS-EI/LLM-OBTEA 获取。稍后我们还将发布论文的预印版。
