...
def get_act_start_goal(seed=1, literals_num=10, iters=10, total_count=1000,pre_max=10000):
    ...
    for count in range(total_count):
        ...
        state = copy.deepcopy(start)
        last_act_total=iters-len(actions)
        if last_act_total<0:
            last_act_total = 0
        # print(last_act_total)
...
# total_count = 5
act_list, start_list, goal_list = get_act_start_goal(seed=seed, literals_num=literals_num, iters=iters,
                                                     total_count=1000)
